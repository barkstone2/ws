			...
			<div>
				<nav id="mainMenu" class="menu">
					...
					<div id="menuMove_member">
						<a href="${path}/member_servlet/index.do">
							회원관리
						</a>
					</div>
			...
			<nav id="userMenu" class="menu">
				<div>
					...
					<div id="yeslogin">
						...
						<div>
							<a href="#" onclick="menuMove('modify')">[회원정보수정]</a>
							<a href="#" onclick="menuMove('delete')">[회원탈퇴]</a>
...
function menuMove(value1){
	location.href='${path}/member_servlet/index.do?menuMove='+value1;
}
</script>
