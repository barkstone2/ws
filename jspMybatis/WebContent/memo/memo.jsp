	...
	<c:forEach var="dto" items="${list}">
		<div class="mlistcon">
			...
			<div class="column4">
				...
				<button type="button" onclick="move('delete','${pageNumber}','${dto.no}');">X</button>
			</div>
		</div>
	</c:forEach>
...
function move(value1, value2, value3){
	var url = "${path}/memo_servlet/memo_"+value1+".do";
	if(value1=='list'){
		...
		location.href='${path}/memo_servlet/memoDelete.do?pageNumber='+value2+'&no='+value3;
	}
}
