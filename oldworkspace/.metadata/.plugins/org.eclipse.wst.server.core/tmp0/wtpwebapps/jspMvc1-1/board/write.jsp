...
<%
	...
	String stepNo_ = request.getParameter("stepNo");
	String refNo_ = request.getParameter("refNo");
	String levelNo_ = request.getParameter("levelNo");
	int no = 0;
	int stepNo = 0;
	int refNo = 0;
	int levelNo = 0;
	if(no_ !=null){
		...
		refNo = Integer.parseInt(refNo_);
		stepNo = Integer.parseInt(stepNo_);
		levelNo = Integer.parseInt(levelNo_);
	}
